...
module EvidenceGatherer
  ...
  autoload :CajaGadgetBuilder, 'evidence_gatherer/caja_gadget_builder'
  autoload :CajoledTestPageBuilder, 'evidence_gatherer/cajoled_test_page_builder'
  autoload :CajaCompiler, 'evidence_gatherer/caja_compiler'
